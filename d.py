...
def set_bot_commands():
    ...
    BotCommand("id", "Get User ID"),
        ...
        BotCommand("bgmi", "START BAD BOY ATTACK"),
...
@bot.message_handler(func=lambda message: message.text in ["⚔️ START BAD BOY ATTACK ⚔️", "RULES ℹ️", "MY LOGS 📝", "HELP ❓", "BUY PLAN 🛒"])
...
@bot.message_handler(func=lambda message: message.text in ["⚔️ START BAD BOY ATTACK ⚔️", "LOGS 📊", "ALL USERS 👥", "CLEAR LOGS 🗑️"])
